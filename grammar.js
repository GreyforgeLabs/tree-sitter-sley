module.exports = grammar({
  ...
  rules: {
    ...
    _item: ($) => choice($.module_declaration, $.import_declaration, $.task_declaration, $.type_declaration, $.effect_declaration),
    ...
    task_declaration: ($) => seq(optional("export"), "task", $.identifier, "->", $.type_expression, optional(seq("uses", commaSep1($.qualified_identifier))), $.block),
    ...
    _statement: ($) => choice($.take_statement, $.binding_statement, $.set_statement, $.return_statement, $.expression_statement, $.if_statement, $.while_statement, $.each_statement),
    ...
    expression: ($) => choice($.call_expression, $.identifier, $.number, $.string, $.bool, $.field_expression, $.result_expression),
